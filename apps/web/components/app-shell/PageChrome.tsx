...
const pageChromeVariantClasses: Record<PageChromeVariant, string> = {
  default:
    "flex min-h-[calc(100vh_-_2.75rem_-_var(--space-9))] flex-col gap-(--space-8) px-(--space-8) py-(--space-8)",
  empty:
    "flex min-h-[calc(100vh_-_2.75rem_-_var(--space-9))] flex-col items-center justify-center gap-(--space-3) px-(--space-8) py-(--space-8) text-center",
  workbench: "flex h-[calc(100vh_-_2.75rem_-_var(--space-9))] min-h-0 flex-col overflow-hidden",
};
